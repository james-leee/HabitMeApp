...
package com.example.cs65project.habitme.view;
...
import com.example.cs65project.habitme.R;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            switch(i){
                case 0:
                    icon = getResources().getDrawable(R.drawable.ic_action);
                    break;
                case 1:
                    icon = getResources().getDrawable(R.drawable.ic_friend);
                    break;
                case 2:
                    icon = getResources().getDrawable(R.drawable.ic_setting);
                    break;
            }
            ColorFilter filter = null;
            if(i == 0){
                filter = new LightingColorFilter(Color.rgb(39,78,19),Color.rgb(39,78,19));
            }else{
                filter = new LightingColorFilter(Color.rgb(77,78,78),Color.rgb(77,78,78));
            }
            icon.setColorFilter(filter);
            tabTitleView.setImageDrawable(icon);
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < mTabStrip.getChildCount(); i++) {
                ...
                Drawable icon = null;
                ImageView imgview = (ImageView)v.findViewById(R.id.tabview);
                switch(i){
                    case 0:
                        icon = getResources().getDrawable(R.drawable.ic_action);
                        break;
