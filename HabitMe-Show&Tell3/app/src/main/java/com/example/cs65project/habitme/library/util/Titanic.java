package com.example.cs65project.habitme.library.util;
    ...
    public void start(final TitanicTextView textView ) {
        ...
        final Runnable animate = new Runnable() {
            ...
            public void run() {
                ...
                maskXAnimator.setRepeatMode(ValueAnimator.RESTART);
...
//                ObjectAnimator maskYAnimator = ObjectAnimator.ofFloat(textView, "maskY", h/2);
