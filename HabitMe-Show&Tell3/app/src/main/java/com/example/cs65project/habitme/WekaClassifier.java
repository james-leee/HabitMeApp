...
/**
 * Created by Mubing on 2/14/15.
 * This file is a training model used as a classifier. It can analyze the data got by sensor and tell
 * the motion type of the user.
 * In our App, we need to know whether the user is running or not.
 */
